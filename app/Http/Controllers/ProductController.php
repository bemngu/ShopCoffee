...
class ProductController extends Controller
{
    ...
    public function ckeditor_image(Request $request){
        if($request->hasFile('upload')) { //nếu có up ảnh
    ...
    public function details_product($product_slug , Request $request){
        ...
        return view('pages.sanpham.show_details')->with('category',$cate_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider)->with('category_post',$category_post)->with('gallery',$gallery)->with('product_cate',$product_cate)->with('cate_slug',$cate_slug)->with('share_images',$share_images);
