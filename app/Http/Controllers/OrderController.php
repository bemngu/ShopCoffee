...
class OrderController extends Controller
{
	...
	public function print_order_convert($checkout_code){ 
		...
		<div class="b">-Coffee Shop MT-</div>
		<h1><center> HÓA ĐƠN THANH TOÁN</center></h1>
		<p><center>----------^-^-----------</center></p>
	

		<p class="a1">Ship hàng tới</p>
		...
		<div class="c">Cảm ơn quý khách đã ủng hộ và hẹn gặp lại!</div>
		<div class="d">409 Trần Địa Nghĩa --- 0385576787</div>
