...
<head>
	...
	<title>Lấy hình ảnh từ máy </title>
	...
	$(document).ready(function(){
		...
		$('#image_list').on('click','img',function(){
			var fileUrl = $(this).attr('title'); //khi click vào thì lấy thuộc tính tittle của ảnh đó
			window.opener.CKEDITOR.tools.callFunction(funcNum,fileUrl); //trả về đường dẫn cho file url
			window.close();
