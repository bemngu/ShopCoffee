                            ...
                            @foreach($post_cate as $key => $p)
                                <div class="single-products" style="margin:10px 0;padding: 2px">
                                        <div class="text-center">
                                                ...
                                                <img style="float:left;width:30%;padding: 5px;height: 170px;border-radius: 24px;margin-right:25px" src="{{asset('public/uploads/post/'.$p->post_image)}}" alt="{{$p->post_slug}}" />
