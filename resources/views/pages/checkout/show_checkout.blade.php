...
<section id="cart_items">
		<div class="container">
			...
			<div class="register-req">
				<p>Bạn hãy đăng nhập trước khi thanh toán giỏ hàng! Cảm ơn <3</p>
			</div><!--/register-req-->
			...
			<div class="shopper-informations">
				<div class="row">
					...
					<div style=" text-align:center;" class="col-sm-12 clearfix">
						<div class="bill-to">
							<p>Điền thông tin gửi hàng</p>
							<div class="form-one">
								<form style="transform: translateX(320px);" method="POST">
									@csrf
									...
									@else 
										<input type="hidden" name="order_fee" class="order_fee" value="99">
									@endif
