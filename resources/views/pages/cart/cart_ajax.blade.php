		...
		<div class="container">
			<div class="breadcrumbs">
			  ...
			  @if(session()->has('message'))
                ...
                @endif
			<div style="width:828px; transform: translateX(-41px)" class="table-responsive cart_info">

				<form action="{{url('/update-cart')}}" method="POST">
					@csrf
				<table style="width:100%;transform: translateX(213px);" class="table table-condensed">
					<thead>
						<tr class="cart_menu">
